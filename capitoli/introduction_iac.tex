...
\intro{An introduction to IaC. The possible approaches are presented, the advantages of using IaC, its challenges, and the evolution of the IaC with the second generation of tools}\\
